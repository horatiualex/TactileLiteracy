...
const fishShadow =
  'drop-shadow(4px 2.1px 0px rgba(0, 0, 0, 0.4)) drop-shadow(1.34px 2.69px 2.69px rgba(255, 255, 255, 1))'

const futureShadow =
  'drop-shadow(4px 2.1px 0px rgba(0, 0, 0, 0.4)) drop-shadow(1.34px 2.69px 2.69px rgba(255, 255, 255, 1))'

const circleShadow = 'drop-shadow(1.42px 2.86px 2.86px rgba(255, 255, 255, 0.7))'
      ...
      timelineItems.map((item, index) => (
        ...
        >
          <img
            ...
            style={{
              filter: index === timelineItems.length - 1 ? futureShadow : fishShadow,
    ...
    >
      ...
      <div className="w-full" ref={timelineRef}>
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr_0.8fr] gap-0 items-center">
          <div className="relative flex items-center justify-start py-20 lg:py-0">
            <div
